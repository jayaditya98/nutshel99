...
// Import the ModelShoots App component from the modelshoots folder
import ModelShootsApp from 'modelshoots/App';

const WorkspaceModelShoots: React.FC = () => {
  return (
...
export default WorkspaceModelShoots;
