...
// Import the CloneShoots App component from the cloneshoots folder
import CloneShootsApp from 'cloneshoots/App';

const WorkspaceCloneShoots: React.FC = () => {
  return (
...
export default WorkspaceCloneShoots;
